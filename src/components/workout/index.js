...
function TodayRoutine({ currentWorkouts, routineId, setCurrentWorkouts, timerOpen, setTimerOpen }) {
  ...
  return (
    <>
                        ...
                        <div>
                          ...
                          >
                            <div>
                              ...
                              <ButtonContainer>
                                <UpdateButton onClick={(e) => updateHandler(e)} id={item.id}>
                                  {' '}
                                  수정
                                </UpdateButton>
                                {/* // 삭제버튼 */}
                                <UpdateButton id={item.id} onClick={(e) => workoutDeleteHandler(e, item.id)}>
                                  {' '}
                                  삭제
                                </UpdateButton>
                              </ButtonContainer>
                            ...
                            <InfoContainer>
                              ...
                              <span>
                                운동시간: {item.set_time_min}분 {item.set_time_sec}초
                              </span>
                              <span>
                                세트 간 휴식: {item.rest_time_min}분 {item.rest_time_sec}초
                              </span>
                            </InfoContainer>
                          </Item>
                        </div>
      ...
      <Modal workoutId={workoutId} setModalOpen={setModalOpen} modalOpen={modalOpen} setCurrentWorkouts={setCurrentWorkouts} currentWorkouts={currentWorkouts}></Modal>
    </>
  );
}
